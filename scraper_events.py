...
url_mar = "http://events.berkeley.edu/?view=summary&timeframe=month&date=2016-03-01&tab=all_events"
url_apr = "http://events.berkeley.edu/?view=summary&timeframe=month&date=2016-04-01&tab=all_events"
url_may = "http://events.berkeley.edu/?view=summary&timeframe=month&date=2016-05-01&tab=all_events"
event_url = "http://events.berkeley.edu/?event_ID="
url_months = [url_feb, url_mar, url_apr, url_may]
...
for url in url_months:
    ...
    r = requests.post("http://kunald.me/campus_events/web/api/scape_berkeley_events.php", data={'event_name': 'test', 'event_id': 'test', 'event_description': 'test'})
